...
def build_ray_next_question(
    ...
    colleague_clarification = build_first_ray_colleague_clarification(
        session=session,
        previous_sessions=previous_sessions,
        sensor_context_observations=sensor_context_observations,
        lang=lang,
    )
    if colleague_clarification:
        colleague_clarification.setdefault("variable_code", None)
        colleague_clarification.setdefault("expected_response_target", None)
        return colleague_clarification
